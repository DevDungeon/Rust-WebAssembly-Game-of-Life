# 🦀🕸️ `Game of Life - Rust & WebAssembly`


Prerequisites
-------------

Install rustup, rustc, cargo, node, npm, wasm-pack 
...
### Initialize index.html www wrapper (already done, do once only)

```
npm init wasm-app www
```

### Run in browser to test
